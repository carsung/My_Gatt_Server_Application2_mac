package com.android.mygattserverapplication;
...
public class GattServerActivity extends AppCompatActivity {
    private static final String TAG = "CSH_GATT_SERVER";
    ...
    private void startAdvertising() {
        ...
        /*if (ActivityCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH_ADVERTISE) != PackageManager.PERMISSION_GRANTED) {
            ...
            String[] permissions = {"android.permission.BLUETOOTH_ADVERTISE",};
    ...
    private BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onServiceAdded(int status, BluetoothGattService service) {
            Log.i(TAG, "onServiceAdded(): " + service);
        }
